...
public class OSGiBundleTest {
    ...
    public void testCodeWriter() {
        Class<?> c = loadClass("com.sun.codemodel.CodeWriter");
        assertClassLoadedByBundle(c, "com.sun.xml.bind.jaxb-xjc");
    }

    @Test
    public void testDriver() {
        Class<?> c = loadClass("com.sun.tools.xjc.Driver");
        assertClassLoadedByBundle(c, "com.sun.xml.bind.jaxb-xjc");
    }

    @Test
    public void testXSOMParser() {
        Class<?> c = loadClass("com.sun.xml.xsom.parser.XSOMParser");
        assertClassLoadedByBundle(c, "com.sun.xml.bind.jaxb-xjc");
    }
