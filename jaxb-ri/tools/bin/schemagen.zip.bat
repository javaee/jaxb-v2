...
:LAUNCHSCHEMAGEN
"%JAVA%" %SCHEMAGEN_OPTS% -cp "%WEBSERVICES_LIB%\jaxb2\lib\jaxb-api.jar;%WEBSERVICES_LIB%\jaxb2\lib\jaxb-impl.jar;%WEBSERVICES_LIB%\jaxb2\lib\jaxb-xjc.jar;%WEBSERVICES_LIB%\jsr173_api.jar;%WEBSERVICES_LIB%\activation.jar;%WEBSERVICES_LIB%\resolver.jar" com.sun.tools.jxc.SchemaGeneratorFacade %*
goto END
