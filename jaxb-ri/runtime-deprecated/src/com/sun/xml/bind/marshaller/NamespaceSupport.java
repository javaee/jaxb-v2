...
// Original version id is as follows:
...

     ...
     *
     * @see #processName(String, String[], boolean)
     * @see #getURI(String)
     ...
     * @see #declarePrefix(String, String)
    ...
    /**
     * Similar to the {@link #getPrefix(String)} method but this method
     * doesn't look for the default namespace and will always return
     * a non-empty prefix or null.
     * 
     * @since JAXB 1.0.2
     */
    public String getPrefix2(String uri) {
        return currentContext.getPrefix2(uri);
    }
...

	 ...
	 * @see org.xml.sax.helpers.NamespaceSupport#declarePrefix(java.lang.String, java.lang.String)
	 */
	 ...
	 * @see org.xml.sax.helpers.NamespaceSupport#processName(java.lang.String, java.lang.String[], boolean)
	 */
	 ...
	 *         declared.	
	 * @see org.xml.sax.helpers.NamespaceSupport#getURI(java.lang.String)
	 */
    ...
    String getPrefix(String uri) {
        if (defaultNS.equals(uri))
            return "";
        return getPrefix2(uri);
    }
    
    /**
     * Similar to the {@link #getPrefix(String)} method but
     * this method doesn't look for the default namespace.
     */
    String getPrefix2(String uri) {
        if (uriTable == null) {
            return null;
        } else {
